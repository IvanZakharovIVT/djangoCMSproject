...
Generated by 'djangocms' command using django CMS 5.0.6 and Django 6.0.3.
...
SECRET_KEY = 'django-insecure-(5at@b_qkj31xli6q*w53cs_a7s-h%4#i0)ce1#d&hj$6tarq@'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'django_cms'),
